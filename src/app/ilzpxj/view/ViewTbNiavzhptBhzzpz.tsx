...
export default function ViewPage<T extends object = { [key: string]: any }>({ initialData, onSave, onSubmit, onCancel }: ViewPageProps<T>) {
    ...
    useEffect(() => {
		...
		if (formData.pkNiavzhpt !== '') {
			axios.post(bpcApiUrl + '/tableview/queryformdata/view_tb_niavzhpt_bhzzpz/' + formData.pkNiavzhpt, {}, {
				headers: {
   ...
   const handleDateError = (itemName: string, dateError: DateValidationError) => {
	...
	const submitFormData = () => {
		setDisabledAction(true);
	      ...
	      axios.post(bpcApiUrl + '/tableview/remixjsondata/view_tb_niavzhpt_bhzzpz', trimObjectValues(formData), {
	        headers: {
	          'grooveToken': token
	        }
	      }).then(response => {
	    	if (response.data && response.data.success) {
	    		setFormData((prevData: any) => ({
					...prevData,
					pkNiavzhpt: response.data.data.pkNiavzhpt,
				}));
    ...
    return (
        <>
            ...
            <ThemeProvider theme={theme}>
                 <form id="form_view_tb_niavzhpt_bhzzpz" onSubmit={handleSubmit}>
                    <div className="space-y-12">
      					    	<div className={groupCardStyle}>
		                            <h2 className={groupTitleStyle}>示数合计</h2>
		                            <p className={groupDescriptionStyle}>
		                                
		                            </p>
		                            <div className={groupContentStyle}>
			<div className={oneColumnStyle}>
	            <label htmlFor="tb_niavzhpt_yqxtneyb" className={labelStyle}>
	                开始日期
	            </label>
	            <div className="mt-2">
	              <FormControl fullWidth ref={(el) => {
													if (el) fieldRefs.current['yqxtneyb'] = el;
												}}>
		               <DatePicker
                          name="yqxtneyb"
                          value={formData.yqxtneyb ? dayjs(formData.yqxtneyb) : null}
                          views={['year', 'month', 'day']}
                          onChange={(newValue: Dayjs | null)=> handleDateChange('yqxtneyb', newValue)}
                          sx={{
                            '.Mui-focused': {
                          ...
                          slotProps={{
                            ...
                            textField: {
                              id: 'tb_niavzhpt_yqxtneyb',
                              error: !!errors['yqxtneyb'],
                              helperText: errors['yqxtneyb'],
                            },
                          }}
                       />
	              </FormControl>
			...
			<div className={oneColumnStyle}>
	            <label htmlFor="tb_niavzhpt_ephegbar" className={labelStyle}>
	                截至日期
	            </label>
	            <div className="mt-2">
	              <FormControl fullWidth ref={(el) => {
													if (el) fieldRefs.current['ephegbar'] = el;
												}}>
		               <DatePicker
                          name="ephegbar"
                          value={formData.ephegbar ? dayjs(formData.ephegbar) : null}
                          views={['year', 'month', 'day']}
                          onChange={(newValue: Dayjs | null)=> handleDateChange('ephegbar', newValue)}
                          sx={{
                            '.Mui-focused': {
                               borderColor: 'oklch(54.6% 0.245 262.881) !important',
                            },
                          ...
                          slotProps={{
                            ...
                            textField: {
                              id: 'tb_niavzhpt_ephegbar',
                              error: !!errors['ephegbar'],
                              helperText: errors['ephegbar'],
                            },
                          }}
                       />
	              </FormControl>
			...
			<div className={oneColumnStyle}>
	            <label htmlFor="tb_niavzhpt_btcqaupc" className={labelStyle}>
	                尖峰时段
	            </label>
	            <div className="mt-2">
	              <FormControl fullWidth ref={(el) => {
													if (el) fieldRefs.current['btcqaupc'] = el;
												}}>
		              <TextField
		                    type="number"
		                    id="tb_niavzhpt_btcqaupc"
		                    name="btcqaupc"
		                    value={formData.btcqaupc || ''}
		                    onChange={handleInputChange}
		                    size="small"
		                    variant="outlined"
		                    error={errors.btcqaupc ? true : false}
		                    helperText={errors.btcqaupc}
		                    slotProps={{
					            input: {
			...
			<div className={oneColumnStyle}>
	            <label htmlFor="tb_niavzhpt_lzbffroj" className={labelStyle}>
	                高峰时段
	            </label>
	            <div className="mt-2">
	              <FormControl fullWidth ref={(el) => {
													if (el) fieldRefs.current['lzbffroj'] = el;
												}}>
		              <TextField
		                    type="number"
		                    id="tb_niavzhpt_lzbffroj"
		                    name="lzbffroj"
		                    value={formData.lzbffroj || ''}
		                    onChange={handleInputChange}
		                    size="small"
		                    variant="outlined"
		                    error={errors.lzbffroj ? true : false}
		                    helperText={errors.lzbffroj}
		                    slotProps={{
					            input: {
			...
			<div className={oneColumnStyle}>
	            <label htmlFor="tb_niavzhpt_yobavxkc" className={labelStyle}>
	                平时段
	            </label>
	            <div className="mt-2">
	              <FormControl fullWidth ref={(el) => {
													if (el) fieldRefs.current['yobavxkc'] = el;
												}}>
		              <TextField
		                    type="number"
		                    id="tb_niavzhpt_yobavxkc"
		                    name="yobavxkc"
		                    value={formData.yobavxkc || ''}
		                    onChange={handleInputChange}
		                    size="small"
		                    variant="outlined"
		                    error={errors.yobavxkc ? true : false}
		                    helperText={errors.yobavxkc}
		                    slotProps={{
					            input: {
			...
			<div className={oneColumnStyle}>
	            <label htmlFor="tb_niavzhpt_jmootdaz" className={labelStyle}>
	                低谷时段
	            </label>
	            <div className="mt-2">
	              <FormControl fullWidth ref={(el) => {
													if (el) fieldRefs.current['jmootdaz'] = el;
												}}>
		              <TextField
		                    type="number"
		                    id="tb_niavzhpt_jmootdaz"
		                    name="jmootdaz"
		                    value={formData.jmootdaz || ''}
		                    onChange={handleInputChange}
		                    size="small"
		                    variant="outlined"
		                    error={errors.jmootdaz ? true : false}
		                    helperText={errors.jmootdaz}
		                    slotProps={{
					            input: {
			...
			<div className={oneColumnStyle}>
	            <label htmlFor="tb_niavzhpt_ndrnhbgb" className={labelStyle}>
	                名称
	            </label>
	            <div className="mt-2">
	              <FormControl fullWidth ref={(el) => {
													if (el) fieldRefs.current['ndrnhbgb'] = el;
												}}>
		              <TextField
		                    id="tb_niavzhpt_ndrnhbgb"
		                    name="ndrnhbgb"
		                    value={formData.ndrnhbgb || ''}
		                    onChange={handleInputChange}
		                    size="small"
		                    variant="outlined"
		                    error={errors.ndrnhbgb ? true : false}
		                    helperText={errors.ndrnhbgb}
		                    slotProps={{
					            input: {
			...
			<div className={oneColumnStyle}>
	            <label htmlFor="tb_niavzhpt_effhvodl" className={labelStyle}>
	                生成日期
	            </label>
	            <div className="mt-2">
	              <FormControl fullWidth ref={(el) => {
													if (el) fieldRefs.current['effhvodl'] = el;
												}}>
		               <DatePicker
                          name="effhvodl"
                          value={formData.effhvodl ? dayjs(formData.effhvodl) : null}
                          views={['year', 'month', 'day']}
                          onChange={(newValue: Dayjs | null)=> handleDateChange('effhvodl', newValue)}
                          sx={{
                            '.Mui-focused': {
                               borderColor: 'oklch(54.6% 0.245 262.881) !important',
                            },
                          ...
                          slotProps={{
                            ...
                            textField: {
                              id: 'tb_niavzhpt_effhvodl',
                              error: !!errors['effhvodl'],
                              helperText: errors['effhvodl'],
                            },
                          }}
                       />
	              </FormControl>
