...
const DataTable: React.ForwardRefRenderFunction<DataTableRef, {page?: number, pageSize?: number, queryParams?: any}> = (props, ref) => {
    ...
    const columnData: ColumnDataProp[] = [
    			...
    			{
		            id: 'pkXbbyezwt', label: '商户ID', minWidth: 150, align: 'center', type: 'number', truncate: true, display: false 
		            				},	
    			{
		            id: 'pkWzghpmog', label: '电价设置ID', minWidth: 150, align: 'center', type: 'number', truncate: true, display: false 
		            				},	
    			{
