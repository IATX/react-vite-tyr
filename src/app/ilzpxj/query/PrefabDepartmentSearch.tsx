...
const DataTable: React.ForwardRefRenderFunction<PrefabRoleListRef, {page?: number, pageSize?: number, queryParams?: any}> = (props, ref) => {
    ...
    const [absokkseOpen, setAbsokkseOpen] = useState(false);

    const columnData: ColumnDataProp[] = [
    			{
		            id: 'name', label: 'Group Name', minWidth: 150, align: 'center', type: 'string', truncate: true
		            				},	
    ];
    ...
    const fetchData = async () => {
        ...
        axios.post(VITE_JET_ASP_BPC_API + '/tablequery/listreacttable/prefab_department_search', params, {
            headers: {
    ...
    const handleDelete = async (val: any) => {
        ...
        if (confirmed) {
            ...
            axios.post(VITE_JET_ASP_BPC_API + '/tableview/deleteformdata/prefab_department_edit', formData, {
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded',
                    'grooveToken': token
                }
    ...
    const bsokkseHandler = () => {
        	setAbsokkseOpen(true);
    }
    ...
    return (
        <>
                        ...
                        <Box>
                        	<Tooltip title="Group Details" arrow>
	                            <Button
	                                ...
	                                onClick={bsokkseHandler}
	                                aria-describedby={'bsokkse'}
	                                size="small"
	                                sx={{
	                                    color: 'hsl(215, 15%, 22%)',
	                                    borderRadius: '12px',
            ...
            <AddDataDialog
                ...
                open={absokkseOpen}
                onClose={() => {
                    setAbsokkseOpen(false);
                }}
                children={WrapSoloFormNode(Parameterization('PrefabDepartmentEdit', {
