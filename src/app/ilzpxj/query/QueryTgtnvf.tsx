...
const DataTable: React.ForwardRefRenderFunction<DataTableRef, {page?: number, pageSize?: number, queryParams?: any}> = (props, ref) => {
    ...
    const [queryData, setQueryData] = useState<Record<string, string>>({
    		...
    		nplhjcqw: props.queryParams?.nplhjcqw ?? '',
    		zymjxejd: props.queryParams?.zymjxejd ?? '',
    });
    ...
    const fetchData = async () => {
        ...
        axios.post(VITE_JET_ASP_BPC_API + '/tablequery/listreacttable/query_tgtnvf', params, {
            headers: {
		...
		if (isInMainArea) {
                ...
                elem: Parameterization('ViewTbWxcheztyNlyrlw', {
                    ...
                    onCancel: (formData: any) => {
                        setCurrentBayContent({
                            title: '消纳比电费账单列表',
                            subheader: '消纳比电费账单列表',
                            elem: Parameterization('QueryTgtnvf', {
								 page: page,
                                 pageSize: pageSize,
            ...
            navigate('app/ilzpxj/view/ViewTbWxcheztyNlyrlw', {
                state: {
                    ...
                    onCancel: (formData: any) => {
                        navigate('app/ilzpxj/query/QueryTgtnvf', {
                			state: {
                				page: page,
                                pageSize: pageSize,
                                queryParams: queryData
