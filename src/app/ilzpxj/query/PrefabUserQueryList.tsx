...
const DataTable: React.ForwardRefRenderFunction<PrefabRoleListRef, {page?: number, pageSize?: number, queryParams?: any}> = (props, ref) => {
    ...
    const columnData: ColumnDataProp[] = [
    			{
		            id: 'name', label: 'User Name', minWidth: 150, align: 'center', type: 'string', truncate: true
		            				},	
    			{
		            id: 'logid', label: 'Login Account', minWidth: 150, align: 'center', type: 'string', truncate: true
		            				},	
    			{
		            id: 'job', label: 'Job', minWidth: 150, align: 'center', type: 'string', truncate: true
		            				},	
    			{
		            id: 'email', label: 'Job', minWidth: 150, align: 'center', type: 'string', truncate: true
		            				},	
    			{
		            id: 'phone', label: 'Phone', minWidth: 150, align: 'center', type: 'string', truncate: true
		            				},	
    			{
    ...
    const fetchData = async () => {
        ...
        axios.post(VITE_JET_ASP_BPC_API + '/tablequery/listreacttable/prefab_user_query_list', params, {
            headers: {
